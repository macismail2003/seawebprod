	...
	validateDataRCM: function(){
		...
		for(var i=0;i<aRCMultipleRCM.length; i++){
			...
			if(aRCMultipleRCM[i].serialNo.trim() == "" && aRCMultipleRCM[i].keyUPC.trim() == "1" && aRCMultipleRCM[i].keyEstType.trim() == "0"){
				...
				if(sap.ui.getCore().byId("idOutDateInputRCM-col4-row"+i).getValue() == ""){
					aRCMultipleRCM[i].valuestateDate = sap.ui.core.ValueState.Error;
					aRCMultipleRCM[i].placeHolderDate = "Required";
					...
					aRCMultipleRCM[i].valuestateDate = sap.ui.core.ValueState.None;
					aRCMultipleRCM[i].placeHolderDate = "";
		...
		for(var i=0;i<aRCMultipleRCM.length; i++){
			var dateEntered = sap.ui.getCore().byId("idOutDateInputRCM-col4-row"+i).getValue();
			if(dateEntered == ""){
				sap.ui.getCore().byId("idOutDateInputRCM-col4-row"+i).setValueState(sap.ui.core.ValueState.Error);
				sap.ui.getCore().byId("idOutDateInputRCM-col4-row"+i).setValue("");
				sap.ui.getCore().byId("idOutDateInputRCM-col4-row"+i).setPlaceholder("Required");
				validDate = false;
			}else if((dateEntered.substr(6,4) + dateEntered.substr(3,2) +  dateEntered.substr(0,2)) > frmtRCMYYYYMMDD){
				busyDialog.close();
				sap.ui.getCore().byId("idOutDateInputRCM-col4-row"+i).setValueState(sap.ui.core.ValueState.Error);
				sap.ui.getCore().byId("idOutDateInputRCM-col4-row"+i).setValue("");
				sap.ui.getCore().byId("idOutDateInputRCM-col4-row"+i).setPlaceholder("No Future Date");
				validDate = false;
			}else if(dateEntered.length != 10){
				busyDialog.close();
				sap.ui.getCore().byId("idOutDateInputRCM-col4-row"+i).setValueState(sap.ui.core.ValueState.Error);
				sap.ui.getCore().byId("idOutDateInputRCM-col4-row"+i).setValue("");
				sap.ui.getCore().byId("idOutDateInputRCM-col4-row"+i).setPlaceholder("Improper Format");
				validDate = false;
			}
			else{
				sap.ui.getCore().byId("idOutDateInputRCM-col4-row"+i).setValueState(sap.ui.core.ValueState.None);
				sap.ui.getCore().byId("idOutDateInputRCM-col4-row"+i).setPlaceholder("");
				validDate = true;
			}
			...
			if(validRCMStatus && validRCMFieldStatus){
				...
				for(var i=0;i<aRCMultipleRCM.length; i++){
					...
					vSrNo = sap.ui.getCore().byId("idSerNoRCMInput-col1-row"+i).getValue();
					...
					vDate = sap.ui.getCore().byId("idOutDateInputRCM-col4-row"+i).getValue();
                    ...
                    if(statusSrNo){
                    	...
                    	if (i > 0 && i<aRCMultipleRCM.length){
	                    		for(var j=0; j <i;j++){
	                    			...
	                    			checkingSrNo = (sap.ui.getCore().byId("idSerNoRCMInput-col1-row"+j).getValue()).toUpperCase();
